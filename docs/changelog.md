...
### Changed
- `openings/one-heart.md`: update major suit raise responses to support points — 2♥ (6–10 sp), 3NT (13–15 sp, no shortness); add NV/V opener rebid thresholds after 2♥
